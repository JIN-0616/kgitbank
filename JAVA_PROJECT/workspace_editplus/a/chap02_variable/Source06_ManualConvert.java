class Source06_ManualConvert {
	public static void main(String[] args) {
		/*
			데이터는 사용될때 변환해서 사용할수 있다.
			자동으로 일어나는 경우야 신경을 안써도 되지만, 수동으로 변환을 해야될때가 있다.
			
			i2d , i2f , l2d, l2f : 소수점이하 실수부 .0 붙인 실수 데이터로 변환
		...
		*/
		...
		double r = 19.97124;
		System.out.println(  (int)r );	// 실수 → 정수 : 소수점을 버리고 정수처리함

		System.out.println( (int)(r*100)/100.0 );

		//=============================================
		// 팔고자 하는 물건가격
		int price = 227000;
		// 출력을 진행하는데, 원가격과 30% 할인된 금액을 출력 (정수출력)
		System.out.println("원가격 : "+ price +", 할인가격 : " +   (int)(price *0.7)  );
		/*
