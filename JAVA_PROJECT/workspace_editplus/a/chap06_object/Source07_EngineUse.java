/*
	객체는 어떤형태로 사용될지 모르기 때문에 너무 특정환경에 맞춰서 설계하는게 좋지 않다.
*/
...
class Source07_EngineUse {
	public static void main(String[] args) {
		...
		while(e1.isRun() ) {
			JOptionPane.showMessageDialog(null, "[SYSTEM] "+e1.tell() +"> ");
		...
		JOptionPane.showMessageDialog(null, "[SYSTEM] UpDownEngine STOPPED");
