...
<body>
 ...
 <div class="all" align="center"> 
 	...
 	<form name="rform" action="bbsreply_editSave.jsp"> 		
 		...
 		<table class="table1">
			...
			<tr> 
				...
				<td > <input type="text" name="writer" value="<%=writer%>" size="22" maxlength="3" onblur="check()"> </td>
				
			</tr>
			<tr>
				<th class="td1"> <label> 내용: </label> </th>
				<td class="td2"> <textarea name="content" onblur="check2()"><%=content %></textarea> </td>				
			</tr>
			<tr>
