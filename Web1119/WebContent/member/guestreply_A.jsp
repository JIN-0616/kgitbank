...
<form action="guestreply_insert.jsp">
 ...
 <table  width=900 border=0 cellspacing=0 >
   ...
   <%
    msg="select g.sabun,r.num,r.writer,r.content from guest g inner join guestreply r on  g.sabun=r.sabun and r.sabun="+Rdata;
    StringBuffer sb = new StringBuffer();
    	sb.append("select g.sabun,r.num,r.writer,r.content from guest g");
    ...
    while(RS.next()==true){
    	Rnum = RS.getInt("num");
    	String Rwriter=RS.getString("writer");
    	String Rcontent=RS.getString("content");
    	int Rsabun=RS.getInt("sabun"); //Rsabun대신 Rdata사용권장 
   %>
