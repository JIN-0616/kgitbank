...
<body>
  ...
  <%
  	...
  	if(skey==null || skey=="" || sval==null || sval==""){
  		sqry = " where title like '%%' "; //모든거 다 출력, 맨앞공백 유의
  		skey=""; sval=""; //강제초기화
  	}else{
  	...
  	returnpage="guestList.jsp?pageNum=3&keyfield=name&keyword=b";
  ...
  <% 
    ...
    if(endpage<pagecount){
    	out.println("<a href='guestList.jsp?pageNum="+(endpage+1)+"')>[다음]</a>");
    }    
    // >> 맨마지막으로 붙이기
