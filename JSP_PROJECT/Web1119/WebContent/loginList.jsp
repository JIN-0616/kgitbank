...
<body>
 <%
  ...
  if(Gtotal>0){
	...
	//세션 session.setAttribute("bank", a);
	//세션 response.sendRedirect("guestList.jsp");
	...
	ck.setMaxAge(60*60*10); //60=1초 
	ck.setMaxAge(0); //쿠키바로소멸
	response.addCookie(ck);
	System.out.println("daum쿠키가 적용되었습니다");
